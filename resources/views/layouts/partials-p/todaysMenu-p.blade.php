<div id="todaysMenu" class="col-12 p-0">
    <div class="p-4  todaysMenu-title">
        ...
        <span>Menu del Día </span>
    </div>

    <div class="p-4 d-flex flex-column  todaysMenu-list">
        <p>SOPA DE RES</p>
        <p>PABELLON</p>
        <p>JUGO DE GUAYABA</p>
        <button class="btn btn-success">DISPONIBLE (15)</button>
    </div>
</div>